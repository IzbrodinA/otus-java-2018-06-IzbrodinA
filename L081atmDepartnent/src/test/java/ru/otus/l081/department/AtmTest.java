...
public class AtmTest {
    ...
    @Test
    public  void saveState() throws InvalidAddBanknote {
        long expected = atm.getAvailableMoney();
        atm.setInitialSetting();
        atm.addBanknote(Banknote.BANKNOTE5000, 2);
        atm.resetInitialSetting();
        assertEquals(expected, atm.getAvailableMoney());
    }

    @Test
    public  void saveStateWithoutInitialSetting() throws InvalidAddBanknote {
        long expected = atm.getAvailableMoney();
        atm.addBanknote(Banknote.BANKNOTE5000, 2);
        atm.resetInitialSetting();
        assertEquals(expected + 5000 * 2, atm.getAvailableMoney());
    }
