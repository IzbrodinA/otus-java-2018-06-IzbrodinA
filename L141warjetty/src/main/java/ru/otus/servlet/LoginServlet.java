...
public class LoginServlet extends HttpServlet {
    ...
    private String getPage(String login, long count) throws IOException {
        ...
        pageVariables.put(LOGIN_VARIABLE_NAME, login == null ? "no request" : login);
        pageVariables.put(COUNT_VARIABLE_NAME, count == 0 ? "no request" : count);
        pageVariables.put(CACHE_VARIABLE_NAME,  dbService.countUsersInCach());
